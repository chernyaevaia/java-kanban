...
public class FileBackedTaskManagerTest {
    ...
    public void testSaveAndLoadSingleTask() {
        Task task = new Task(0, "Test Task", "Test Description", TaskStatus.NEW, Duration.ZERO, null);
    ...
    public void testSaveAndLoadMultipleTypes() {
        ...
        Subtask subtask = new Subtask(0, "Test Subtask", "Subtask Description", TaskStatus.DONE, epicId, Duration.ZERO,
                null);
    ...
    public void testEpicSubtaskRelationshipsPreserved() {
        ...
        Subtask subtask2 = new Subtask(0, "Subtask 2", "Description 2", TaskStatus.DONE, epicId, Duration.ZERO, null);
    ...
    public void testAutoSaveAfterOperations() throws IOException {
        Task task = new Task(0, "Auto Save Test", "Description", TaskStatus.NEW, Duration.ZERO, null);
    ...
    public void testUpdatesAndDeletesPersist() {
        Task task = new Task(0, "Delete Test", "Description", TaskStatus.NEW, Duration.ZERO, null);
        int taskId = taskManager.addNewTask(task);
    ...
    public void testIdGenerationAfterLoading() {
        Task task1 = new Task(0, "First Task", "Description", TaskStatus.NEW, Duration.ZERO, null);
        int id1 = taskManager.addNewTask(task1);

        FileBackedTaskManager loadedManager = FileBackedTaskManager.loadFromFile(tempFile);

        Task task2 = new Task(0, "Second Task", "Description", TaskStatus.NEW, Duration.ZERO, null);
