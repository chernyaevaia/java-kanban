...
public class Main {
	public static void main(String[] args) {
		...
		// Создание
		Task task1 = new Task(0, "Task #1", "Task1 description", NEW, null, null);
		Task task2 = new Task(0, "Task #2", "Task2 description", IN_PROGRESS, null, null);
		...
		Subtask subtask1 = new Subtask(epicId2, "Subtask #1-1", "Subtask1 description", NEW, epicId1, null, null);
		Subtask subtask2 = new Subtask(epicId2, "Subtask #2-1", "Subtask1 description", NEW, epicId1, null, null);
		Subtask subtask3 = new Subtask(epicId2, "Subtask #3-2", "Subtask1 description", DONE, epicId2, null, null);
